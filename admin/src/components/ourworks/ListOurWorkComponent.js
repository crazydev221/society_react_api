...
export default class ListOurWorkComponent extends Component {
    constructor(props) {
        super(props);
    ...
    viewOurWork(_id) {
        this.props.history.push(`/view-ourwork/${_id}`);
    }

    editOurWork(_id) {
        this.props.history.push(`/add-ourwork/${_id}`);
    }

    addOurWork() {
        this.props.history.push('/add-ourwork/_add');
    }
    ...
    componentDidMount() {
        ...
        if (page !== this.state.pager.currentPage) {
            OurWorkService.getLists(page).then((ourworks) => {
                ...
                this.setState({ourworks: ourworks.data.ourworks});
            });
    ...
    render() {
        ...
        return (
            <div className="col-12">
                <h2 className="text-center">Our Work Gallery List</h2>
                <div className="mb-3">
                    <button className="btn btn-primary" onClick={this.addOurWork}> Add Our Work Gallery</button>
                </div>
                                ...
                                this.state.ourworks.map(
                                    ...
                                    <tr key={ourwork._id}>
                                        ...
                                        <td><img className="main-img"
                                                 src={HttpCommon.defaults.imageURL + '/uploads/ourworks/' + ourwork.picture}
                                                 alt=""/></td>
                                        <td>

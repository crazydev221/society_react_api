...
export default class CreateOurWorkComponent extends Component {
    constructor(props) {
        super(props);
    ...
    getTitle() {
        if (this.state._id === '_add') {
            return <h2 className="text-center">Add Our Work Gallery</h2>
        } else {
            return <h2 className="text-center">Update Our Work Gallery</h2>
        }
    }
    ...
    renderPreview() {
        if (this.state.src) {
            ...
            return <img class="main-img"
                        src={HttpCommon.defaults.imageURL + '/uploads/ourworks/' + this.state.picture}/>;
        } else {
            return "";
        }
    }

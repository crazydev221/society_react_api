...
export default class ListNitaliaBlanketComponent extends Component {
    constructor(props) {
        super(props);
    ...
    viewOurWork(_id) {
        this.props.history.push(`/view-nitaliablanket/${_id}`);
    }

    editOurWork(_id) {
        this.props.history.push(`/add-nitaliablanket/${_id}`);
    }

    addOurWork() {
        this.props.history.push('/add-nitaliablanket/_add');
    }
    ...
    componentDidMount() {
        ...
        if (page !== this.state.pager.currentPage) {
            OurWorkService.getLists(page).then((ourworks) => {
                ...
                this.setState({ourworks: ourworks.data.nitaliablankets});
            });
    ...
    render() {
        ...
        return (
            <div className="col-12">
                <h2 className="text-center">Nitalia Blanket Gallery List</h2>
                <div className="mb-3">
                    <button className="btn btn-primary" onClick={this.addOurWork}> Add Nitalia Blanket Gallery
                    </button>
                </div>
                                ...
                                ourwork =>
                                    <tr key={ourwork._id}>
                                        ...
                                        <td><img className="main-img"
                                                 src={HttpCommon.defaults.imageURL + '/uploads/nitaliablankets/' + ourwork.picture}
                                                 alt=""/></td>

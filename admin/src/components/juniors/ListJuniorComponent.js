...
import OurWorkService from '../../services/JuniorPurpleSocietyService';
...
export default class ListJuniorComponent extends Component {
    ...
    viewOurWork(_id) {
        this.props.history.push(`/view-junior/${_id}`);
    }

    editOurWork(_id) {
        this.props.history.push(`/add-junior/${_id}`);
    }

    addOurWork() {
        this.props.history.push('/add-junior/_add');
    }
    ...
    componentDidMount() {
        ...
        if (page !== this.state.pager.currentPage) {
            OurWorkService.getLists(page).then((ourworks) => {
                ...
                this.setState({ourworks: ourworks.data.juniorpurplesocieties});
            });
    ...
    render() {
        ...
        return (
            <div className="col-12">
                <h2 className="text-center">Junior Purple Society List</h2>
                <div className="mb-3">
                    <button className="btn btn-primary" onClick={this.addOurWork}> Add Junior Purple Society
                    </button>
                </div>
                                ...
                                ourwork =>
                                    <tr key={ourwork._id}>
                                        ...
                                        <td><img className="main-img"
                                                 src={HttpCommon.defaults.imageURL + '/uploads/juniorpurplesocieties/' + ourwork.picture}
                                                 alt=""/></td>

...
key: (req, file, cb) => {
    ...
    cb(null, 'uploads/supports/'+Date.now() + fileName);
}
...
module.exports = function(app) {
  ...
  app.post('/api/supports', upload.single('image'), controller.create);
  app.get('/api/supports', controller.findAll);
  app.get('/api/supports/:id', controller.findOne);
  app.put('/api/supports/:id', upload.single('image'), controller.update);
  app.delete('/api/supports/:id', controller.delete);
